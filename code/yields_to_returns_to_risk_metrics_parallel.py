...
# =============================================================================
    ...
    def save_results_old(self):
        ...
        metrics_file_path = self.metrics_dir  / f"metrics_timeseries_{self.model_name}.csv"
        lock_file_path = f"{metrics_file_path}.lock"
        ...
        with lock:
            ...
            metrics_df.to_csv(
                metrics_file_path,
                mode='a',  # Append mode
                header=not metrics_file_path.exists(),  # Write header if the file does not exist
                index=False  # Do not write the index column
            )
